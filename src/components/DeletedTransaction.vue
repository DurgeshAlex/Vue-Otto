      ...
      <div class="md-layout-item md-size-100">
        <md-table v-model="tableData" md-card>
         ...
         <md-table-row slot="md-table-row" slot-scope="{ item }" md-selectable="multiple">
            ...
            <md-table-cell md-label="State" md-sort-by="state"><span :class="'invoiceStatus-tag color' + item.state">&#9679; <span :class="'invoiceStatus-tag color' + item.state">{{ stateArray[item.state-1] }}</span></span> </md-table-cell>
